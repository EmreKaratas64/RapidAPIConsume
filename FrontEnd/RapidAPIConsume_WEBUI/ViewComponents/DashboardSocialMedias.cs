...
namespace RapidAPIConsume_WEBUI.ViewComponents
{
    public class DashboardSocialMedias : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            ViewBag.InstagramFollowers = "499";
            ViewBag.InstagramFollowed = "100";
            //}
            ...
            ViewBag.TwitterFollowing = "189";
            ViewBag.TwitterFollowers = "987";
            ...
            //        }
            ViewBag.LinkednFollowing = "155";
            ViewBag.LinkednFollowers = "1147";
            return View();
        }
    }
}
