...
{
    public class HomePageAbout : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public HomePageAbout(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessasge = await client.GetAsync("http://localhost:5291/api/About");
