...
namespace RapidAPIConsume_DataAccessLayer.Migrations
{
    public partial class database_withIdentity_Formed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkDepartment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkLocationID = table.Column<int>(type: "int", nullable: false),
